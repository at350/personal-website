...
export const siteMeta = {
  name: "Alan Tai",
  title: "Alan Tai | Builder, researcher, former newsroom kid",
  description:
...
export const navigation = [
  { label: "Cover", href: "#cover", folio: "00" },
  { label: "About", href: "#about", folio: "02" },
  { label: "Projects", href: "#projects", folio: "06" },
  { label: "Resume", href: "#resume", folio: "12" },
  { label: "Library", href: "#library", folio: "18" },
  { label: "Dispatches", href: "#dispatches", folio: "22" },
  { label: "Contact", href: "#contact", folio: "26" },
