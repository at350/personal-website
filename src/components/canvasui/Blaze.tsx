/* Canvas UI "Blaze" — fire at the bottom of the page.
   Standalone source from https://canvasui.dev/docs/components/blaze */
  ...
  if (htmlInCanvas) {
    paintable.onpaint = () => {
      try {
        ...
        /* capture can transiently fail; the next paint retries */
      }
    };
  }
