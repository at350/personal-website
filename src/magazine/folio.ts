...
export const SPREADS: readonly SpreadDef[] = [
  ...
  { id: "profile", route: "/profile", label: "The Profile", runningHead: "THE PROFILE", kind: "spread" },
  ...
  { id: "resume", route: "/resume", label: "The Annotated Resume", runningHead: "THE ANNOTATED RESUME", kind: "spread" },
  { id: "library", route: "/library", label: "The Library", runningHead: "THE LIBRARY", kind: "spread" },
  { id: "dispatches", route: "/writing", label: "Dispatches", runningHead: "DISPATCHES", kind: "spread" },
