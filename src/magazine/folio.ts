...
export const SPREADS: readonly SpreadDef[] = [
  ...
  { id: "profile", route: "/profile", label: "News / Profile", runningHead: "NEWS", kind: "spread" },
  ...
  { id: "resume", route: "/resume", label: "Sports / Résumé", runningHead: "SPORTS", kind: "spread" },
  { id: "library", route: "/library", label: "Arts & entertainment / Library", runningHead: "ARTS & ENT", kind: "spread" },
  { id: "dispatches", route: "/writing", label: "Opinion / Writing", runningHead: "OPINION", kind: "spread" },
  { id: "letters", route: "/contact", aliases: ["/colophon"], label: "Letters / Contact", runningHead: "LETTERS", kind: "spread" },
